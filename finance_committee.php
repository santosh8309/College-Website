...
<h4 align="center">FINANCE COMMITTEE</h4>
...
<table class="table">
  <tr>
    <th class="th"> </th>
    <th class="th">Finance committee members</th>
  
  </tr>
    
   <tr>
     <td class="td">1</td>
     <td class="td">Prof T. Harinarayana<br>
GERMI,Chairman</td>
     </tr>
...
Director, DA-IICT</td>
   ...
   <tr>
     <td class="td">3</td>
     <td class="td">Shri S.K. Bajpai<br>
DGM, Finance GSFC</td>
...
Registrar, IIIT-Vadodara</td>
     ...
     <tr>
     <td class="td">5</td>
     <td class="td">Shri Anomitra Das<br>
Representative (TCS)</td>
    
    </tr> 
     <tr>
     <td class="td">6</td>
     <td class="td">Shri P.R. Dave<br>
Jt. Director, DTE</td>
