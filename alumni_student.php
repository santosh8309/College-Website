...
<html lang="en">
<head>
	<title>List of Alumni student</title>
...
<div id="fee_table">
    <h3 align="center">List of all pass out student</h3>
<table class="table">
  <tr>
...
$sql="select * from alumni where s_branch='$s_branch' order by s_batch";
...
?>
   ...
   <tr>
     <td class="td"><?php echo $row["s_name"]?></td>
     <td class="td"><?php echo $row["student_id"]?></td>
     
       <td class="td"><?php echo $row["s_batch"]?></td>
