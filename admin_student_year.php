...
?>
   ...
   <div class="help_desk">
       ...
       <div id="cs_it">
               ...
               <form method="post" action="admin_show_student.php">
...
value="<?php echo $_POST['branch']; ?>">
        ...
        <input type="radio" name="batch" value="2016-17" checked>&nbsp;&nbsp;<b>First year student</b> <br>
         <input type="radio" name="batch" value="2015-16" checked>&nbsp;&nbsp;<b>Second year student</b> <br>
    <input type="radio" name="batch" value="2014-15" checked>&nbsp;&nbsp;<b>Third year student</b> <br>
     <input type="radio" name="batch" value="2013-14" checked>&nbsp;&nbsp;<b>Forth year student</b> <br><br>
