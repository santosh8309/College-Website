...
?>
   ...
   <div class="help_desk">
       ...
       <div id="cs_it">
    <form method="post" action="admin_student_year.php">
        <input type="hidden" name="variable"
value="<?php echo $_POST['variable']; ?>">

        <h3>Select Student</h3><br>
        <input type="radio" name="branch" value="CSE" checked>&nbsp;&nbsp;<b>CSE</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="radio" name="branch" value="IT">&nbsp;&nbsp;<b>IT</b><br> <br>
